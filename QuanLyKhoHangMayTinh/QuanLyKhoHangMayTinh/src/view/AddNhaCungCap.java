...
public class AddNhaCungCap extends javax.swing.JDialog {
            ...
            if (maNcc.equals("") || tenNcc.equals("") || sdtNcc.equals("") || diachiNcc.equals("")) {
                ...
                if (NhaCungCapDAO.getInstance().selectById(maNcc) == null) {
                    ...
                    this.dispose();
                        ...
                        JOptionPane.showMessageDialog(this, "Vui lòng nhập sđt ở dạng số !", "Cảnh báo =", JOptionPane.WARNING_MESSAGE);
                    }
                }
                else {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Long.parseLong(input); // Chuyển đổi chuỗi thành số nguyên
            return true;
