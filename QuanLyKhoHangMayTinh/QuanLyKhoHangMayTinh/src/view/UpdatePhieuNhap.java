...
public class UpdatePhieuNhap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnNhapHang.setBackground(new java.awt.Color(0, 102, 204));
        btnNhapHang.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        ...
        addProduct.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
    ...
    private void addProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addProductActionPerformed
        ...
        if (i_row == -1) {
            ...
            if(isInteger(txtSoLuong.getText().trim())){
 ...
 static boolean isInteger(String input) {
        try {
            Integer.parseInt(input); // Chuyển đổi chuỗi thành số nguyên
            return true;
